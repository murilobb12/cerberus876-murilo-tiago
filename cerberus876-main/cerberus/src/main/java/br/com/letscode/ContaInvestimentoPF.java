...
public class ContaInvestimentoPF extends ContaCorrentePF {

    public ContaInvestimentoPF(ClientePF titular, int numeroConta) {
    ...
    public void render() {
        this.saldo = saldo.multiply(new BigDecimal("1.10"));
    }
